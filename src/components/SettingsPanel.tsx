    ...
    const ToggleSwitch = ({ checked, onChange }: { checked: boolean; onChange: (checked: boolean) => void }) => (
        <div className="relative">
            ...
            <div
                ...
                className={`w-11 h-6 rounded-full cursor-pointer transition-colors ${checked ? "bg-blue-600" : "bg-gray-300"
                    }`}
            >
                <div
                    className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform transform ${checked ? "translate-x-6" : "translate-x-1"
                        } mt-1`}
                />
            </div>
        </div>
                                ...
                                {[
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex items-center gap-2 p-2 rounded-lg border transition-colors ${settings.theme === theme.id
