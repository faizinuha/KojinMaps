...
import { X, Navigation, MapPin, Car, Bike, User } from "lucide-react"
...
export default function NavigationModal({
  ...
  }, [isOpen, userLocation, destination, transportMode])
          ...
          {!userLocation && (
            <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1 bg-yellow-600 text-white text-sm rounded hover:bg-yellow-700 transition-colors"
              >
                <Navigation size={14} />
                Dapatkan Lokasi
              </button>
