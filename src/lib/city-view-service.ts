 ...
 */
export function getOpenStreetMapSatelliteUrl(location: LocationData, width = 800, height = 600, zoom = 15): string {
 ...
 */
export function getOpenStreetMapStreetViewUrl(location: LocationData, width = 800, height = 600, zoom = 17): string {
 ...
 */
export function getSimpleMapUrl(location: LocationData, viewType: "satellite" | "map" | "streetview" = "map"): string {
  const baseUrl = "https://maps.googleapis.com/maps/api/staticmap"
  const maptype = viewType === "satellite" ? "satellite" : viewType === "map" ? "roadmap" : "roadmap"
